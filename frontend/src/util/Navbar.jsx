    ...
    <>
      <div id="Header">
        <div id="Fixed">
          <div id="Home_Buttons">
            {/* <Link to="/login">  */}
            <a href="#"><img id="Blue_Logo" src="https://cdn.shopify.com/s/files/1/0248/3473/6191/files/BLUEFLY-LOGO-11-20.png?v=1574278243" alt="" /></a>
            <a href="#"><img className="H_but" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWXI_JyOVRGL5fOKjn9qMUF3pWkgFcfDm1oQ&usqp=CAU" alt="" /></a>
            ...
            <a href="#"><img className="H_but" src="https://media.istockphoto.com/vectors/thin-line-shopping-bag-icon-illustration-design-vector-id653355496?k=20&m=653355496&s=170667a&w=0&h=VQQIU3uqbQuubef1qJCnAobIImZwE1LLbx51XIqQlPY=" alt="" /></a>
          </div>
          <nav>
            <p className="hoverEff" id="Shoe_Hover"><a href="#">SHOES</a></p>
